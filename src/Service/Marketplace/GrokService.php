...
PROMPT;
    ...
    // ════════════════════════════════════════════════════════════════════
    //  APPEL GÉNÉRIQUE (autres modules, ex. e-learning)
    // ════════════════════════════════════════════════════════════════════

    /**
     * @param list<array{role: string, content: string}> $messages
     */
    public function chatWithMessages(array $messages, int $maxTokens = 400, float $temperature = 0.35): ?string
    {
        return $this->callMessages($messages, $maxTokens, $temperature);
    }
     ...
     * @param list<array{role: string, content: string}> $messages
     */
    private function callMessages(array $messages, int $maxTokens, float $temperature): ?string
    {
