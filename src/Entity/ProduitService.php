...
class ProduitService
{
    ...
    public function setIdProfile(?int $v): self { $this->idProfile = $v; return $this; }
    ...
    public function setDisponible(bool $v): self { $this->disponible = $v; return $this; }

    public function getOwnerUserId(): ?int { return $this->ownerUserId; }
    public function setOwnerUserId(?int $v): self { $this->ownerUserId = $v; return $this; }

    public function getImagePath(): ?string { return $this->imagePath; }
    public function setImagePath(?string $v): self { $this->imagePath = $v; return $this; }
