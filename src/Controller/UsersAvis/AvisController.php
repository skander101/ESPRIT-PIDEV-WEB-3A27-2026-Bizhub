...
class AvisController extends AbstractController
{
    ...
    public function create(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($formation === null || $this->participationRepository->findPaidByUserAndFormation($user, $formation) === null) {
    ...
    private function handleEdit(Request $request, Avis $avi): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $formation = $avi->getFormation();
            if ($formation === null || ($user instanceof User && $this->participationRepository->findPaidByUserAndFormation($user, $formation) === null && !$this->isGranted('ROLE_ADMIN'))) {
                $this->addFlash('error', 'You must participate in this formation before leaving a review.');
