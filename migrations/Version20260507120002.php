...
final class Version20260507120002 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Sync DB schema to match entity mapping';
    }

    public function up(Schema $schema): void
    {
        // Fix orders table FKs (drop old ones, add new ones with proper names)
        ...
        // Fix commande_status_history FK
        ...
        // Fix produit_service table (typo table name from old code)
        ...
        $this->addSql('ALTER TABLE participation ADD CONSTRAINT `participation_ibfk_1` FOREIGN KEY (user_id) REFERENCES app_user (user_id)');
        $this->addSql('ALTER TABLE participation ADD CONSTRAINT `participation_ibfk_2` FOREIGN KEY (formation_id) REFERENCES formation (formation_id)');
        ...
        $this->addSql('ALTER TABLE formation ADD CONSTRAINT `formation_ibfk_1` FOREIGN KEY (trainer_id) REFERENCES app_user (user_id)');
        $this->addSql('CREATE INDEX idx_formation_trainer ON formation (trainer_id)');

        // Fix negotiation table
        ...
        $this->addSql('ALTER TABLE negotiation ADD CONSTRAINT `negotiation_ibfk_2` FOREIGN KEY (startup_id) REFERENCES app_user (user_id)');
        $this->addSql('ALTER TABLE negotiation ADD CONSTRAINT `negotiation_ibfk_3` FOREIGN KEY (investor_id) REFERENCES app_user (user_id)');
        ...
        $this->addSql('ALTER TABLE deal ADD CONSTRAINT `deal_ibfk_1` FOREIGN KEY (project_id) REFERENCES project (project_id)');
        $this->addSql('ALTER TABLE deal ADD CONSTRAINT `deal_ibfk_2` FOREIGN KEY (negotiation_id) REFERENCES negotiation (negotiation_id)');
        $this->addSql('ALTER TABLE deal ADD CONSTRAINT `deal_ibfk_3` FOREIGN KEY (buyer_id) REFERENCES app_user (user_id)');
        $this->addSql('ALTER TABLE deal ADD CONSTRAINT `deal_ibfk_4` FOREIGN KEY (seller_id) REFERENCES app_user (user_id)');
        ...
        $this->addSql('ALTER TABLE post ADD CONSTRAINT `post_ibfk_1` FOREIGN KEY (user_id) REFERENCES app_user (user_id)');
    ...
    {
        // Simplified down migration - restore some old FKs
