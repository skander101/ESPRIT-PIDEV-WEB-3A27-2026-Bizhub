...
final class Version20260507130001 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Sync DB schema with entity mapping (column types, FKs, indexes)';
    }

    public function up(Schema $schema): void
    {
        // ========== orders table ==========
        // The schema:update wants to DROP these but they dont exist with these names
        // FK_orders_buyer and FK_orders_product - skip these DROPs
        ...
        // Add proper FKs with_backtick names
